    ...
    while (pilihan != 0){
        if (pilihan == 1 ) {
            ...
            if ( username == datauser[j].username && password == datauser[j].password) {
                    ...
                    cout << "[2] | Insert Data Hobby                                    |" << endl;
                    cout << "[3] | Insert Data Hobby kedalam data alumni                |" << endl;
                    cout << "============================================================" << endl ;
                    cout << "|                      Edit Menu                           |"<< endl;
                    cout << "============================================================" << endl ;
                    cout << "[4] | Edit Data Alumni                                     |" << endl;
                    cout << "[5] | Edit Data Hobby                                      |" << endl;

                    cout << "============================================================" << endl ;
                    cout << "|                      Hapus Menu                          |" << endl;
                    cout << "============================================================" << endl ;
                    cout << "[6] | Hapus Data Alumni                                    |" << endl;
                    cout << "[7] | Hapus Data Hobby                                     |" << endl;
                    cout << "============================================================" << endl ;
                    cout << "|                      Cari Menu                           |" << endl;
                    cout << "============================================================" << endl ;
                    cout << "[8] | Cari Data Alumni berdasarkan Hobby                   |" << endl ;
                    cout << "[9] | Cari Data Hobby Berdasarkan Alumni                   |" << endl ;
                    cout << "============================================================" << endl ;
                    cout << "|                     Tampil Menu                          |" << endl;
                    cout << "============================================================" << endl ;
                    cout << "[10]| Tampil Data Alumni                                   |" << endl;
                    cout << "[11]| Tampil Data Hobby                                    |" << endl;
                    cout << "[12]| Tampil Data Alumni Beserta Hobby                     |" << endl;
                    cout << "[13]| Tampilkan Hobby terbanyak Dimiliki alumni            |" << endl;
                    cout << "[0] | keluar                                               |" << endl;
                    cout << "============================================================" << endl;
                    cout << endl;
                    cout << "pilihan = ";
                    ...
                    while (pilihan != 0) {
                        if (pilihan == 1) {
                            ...
                            cout << "|  data    | Masukan Data yang Ingin di hapus berdasarkan Hobby    : ";
                            cin>>Karir;
                            cout << "--------------------------------------------------------------------------" << endl;
                            cout << endl;
                            ...
                            cout << "--------------------------------------------------------------------------" << endl;
                            cout << "|  Cari  | Cari Data Hobby  Berdasarkan    " << endl;
                            cout << "|  data  | Id Alumni                     : ";
                            cin>>x;
                            cout << "--------------------------------------------------------------------------" << endl;
                            cout << endl;
            ...
            cout << "|     akun     | masukan kode untuk memvertifikasi bahwa kamu seorang alumni !!  |" << endl;
            cout << "========================================================================="<< endl;
            ...
            if (kode == "12345"){
                system("CLS");
                cout << "==========================================" << endl;
                cout << "| masukan data alumni baru !!             |" << endl;
                cout << "==========================================" << endl;
                cout << "| Username = " ;
                cin >> username;
