...
void inputrelasi (list_Relasi &lr,list_Parent lp,list_Child lc) {
    ...
    if (x != -1){
        ...
        if (q != NULL) {
            ...
            system("CLS");
            cout << "data Hobby tidak ada !!" << endl;
        }
...
void tampildataKarirtertentu(list_Relasi l,int id){
    ...
    if (firstRelasi(l) == NULL) {
        ...
        if (id != -1) {
            p = firstRelasi(l);
            cout << "============================================================="<< endl;
            cout << "| tampil | Tampil Semua data Hobby                           |" << endl ;
            cout << "-------------------------------------------------------------" << endl ;
            while (p != NULL) {
...
void KarirTerbanyak(list_Relasi l,list_Child lc ){
    ...
    if (firstRelasi(l) == NULL && firstChild(lc) == NULL) {
       cout << "Data Kosong !!!" << endl << endl;
        ...
        q = firstChild(lc);
        i = 0;
        cout << "============================ HOBBY TERBANYAK !!! ============================" << endl << endl;
        while (nextChild(q) != firstChild(lc)) {
            if (infoChild(q).jumlah == banyak){
                i = i + 1;
                cout << "| No = " << i << " | Hobby = " << infoChild(q).Karir ;
                cout << " | Hobby paling banyak = " << infoChild(q).jumlah << " | ";
                cout << endl;
            }
            q = nextChild(q);
        }
...
void printListRelasi(list_Relasi l) {
    ...
    if (firstRelasi(l) == NULL) {
        ...
        while (p != NULL) {
            ...
            cout << "|        | Hobby Alumni                      = " << infoChild(botRelasi(p)).Karir << endl;
            cout << "--------------------------------------------------------------"<< endl;
            p = nextRelasi(p);
        }
    }
